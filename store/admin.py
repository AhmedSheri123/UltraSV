...
from .models import StoreTypes, ServiceTypes, Services, ServicesDownloads, ServiceViews, WaitForAccept, EditedServicesWaitForAccept
from modeltranslation.admin import TranslationAdmin
# Register your models here.
admin.site.register(ServicesDownloads)
admin.site.register(ServiceViews)
admin.site.register(WaitForAccept)
...
@admin.register(EditedServicesWaitForAccept)
class EditedServicesWaitForAcceptAdmin(TranslationAdmin):
    list_display = ('id', 'title')
    class Media:
        js = (
            'http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',
